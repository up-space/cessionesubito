...
export default function PromoPage() {
  ...
  const features = [
    { text: 'Di aziende a partire da 8 dipendenti', icon: Euro },
    { text: 'Ottieni fino a € 60.000', icon: Calendar },
    { text: 'Approvazione in 48h', icon: FileText },
    { text: 'Accessibilità anche a cattivi pagatori e protestati', icon: Percent }
  ];
          ...
          >
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
              ...
              <div className="flex-1 space-y-6 text-center md:text-left">
                ...
                >
                  Soluzioni finanziarie su misura per i dipendenti di aziende partner. 
                  <br />
                  Approvazione rapida e condizioni competitive.
                </motion.p>
