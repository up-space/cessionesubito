          ...
          <div className="flex flex-col gap-8 md:gap-16">
            ...
            <div className="relative">
              <div 
                ...
                className="flex md:grid md:grid-cols-3 gap-4 md:gap-8 overflow-x-auto md:overflow-x-visible pb-6 md:pb-0
              ...
              >
                {products.map((product, index) => (
                  <Link 
                    href={product.href} 
                    key={index}
                    className="flex-none w-[85vw] sm:w-[70vw] md:w-auto snap-center"
                  >
                    <motion.div
                      variants={itemVariants}
